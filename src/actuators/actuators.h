...
void deployerLifter(int speed = 80);
void retracterLifter(int speed = 80);
void ouvrirGripper(int speed = 80);
void libererStock(int speed = 10);
void fermerGripper(int speed = 80);
